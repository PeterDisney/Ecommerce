...
const Navbar = () => {
    return (
        <div className=' w-full text-white bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black'>
            ...
            <div className=' mx-auto max-w-screen-xl w-full flex justify-center sm:justify-between items-center py-2 px-4 xsm:justify-between items-center text-white bg-transparent font-body flex-wrap'>
